...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <a href="<?php echo U('Notes/add');?>" class="btn btn-primary">新建公告</a>
        </div>
        <div class="col-md-6">
            <br><br>
            <form action="<?php echo U('Notes/index');?>" method="post">
    ...
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                ...
                <td><a href="<?php echo U('Notes/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>

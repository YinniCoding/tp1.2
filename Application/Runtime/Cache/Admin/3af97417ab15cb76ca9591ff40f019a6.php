    ...
    <div class="col-md-12" style="padding: 0; ">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h2 class="panel-title">新增公告</h2>
                    </div>
                </div>
        </div>
    <form method="post" action="<?php echo U('Notes/add');?>">
        <div class="form-group">
            <label for="page-title">作者</label>
            <input type="text" name="id" class="form-control" id="page-title" placeholder="作者">
        </div>
        <div class="form-group">
            <label for="page-name">时间</label>
            <input type="text" name="date" class="form-control" id="page-name" placeholder="默认">
        </div>
        <div class="form-group">
            <label for="page-content">公告内容</label>

            ...
            <nav class="navbar navbar-default" role="navigation" data-toggle="collapse" style="margin:1px;">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                    <ul class="nav navbar-nav" style="margin-left:160px;">
                      <li class="active" ><a href="<?php echo U('Page/cppsuanfa1');?>">总述</a></li>
            ...
            <div class="Tutorial">
                <div id="html5基础知识">
                  <div id="htmlcontent">
                      <tr>
                        <?php
 error_reporting(0); $con = mysql_connect("localhost","root"); if (!$con){ die('Could not connect: ' . mysql_error()); } mysql_select_db('tpadmin',$con); mysql_query("set names utf8"); $sql = "select * from post where  id = '3'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); ?>
                        <tr>
                        <?php

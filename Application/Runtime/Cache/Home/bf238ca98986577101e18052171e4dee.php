...
<?php
error_reporting(0); $str = $_POST['code']; $file="D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/cpp/cppcode.cpp"; $fp=fopen($file,"w");fwrite($fp,$str);fclose($fp); exec("cl cppcode.cpp",$output,$return_val); exec("cppcode.exe",$output1,$return_val1); ?> 

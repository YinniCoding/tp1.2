...
<div class="row">
	...
	<div class="col-md-12" style="margin-left:0px;margin-top:50px;">
		<div class="panel panel-default">
            ...
            <option  value="">python 在线工具</option>         
            <option  value="">C 在线工具</option>         
...
<?php
error_reporting(0); $str = $_POST['code']; $file="D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/csharp/csharpcode.cs"; $fp=fopen($file,"w");fwrite($fp,$str);fclose($fp); exec("csc D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/csharp/csharpcode.cs",$output,$return_val); exec("csharpcode.exe",$output1,$return_val1); ?> 

                  <div class="col-md-5">
                    <textarea placeholder="程序正在运行中……" value="" class="form-control" id="compiler-textarea-result" rows="18">
                      <?php  echo "\n"; while ($color=each($output1)) { echo $color['value']; echo "\n"; } ?>
                    </textarea>

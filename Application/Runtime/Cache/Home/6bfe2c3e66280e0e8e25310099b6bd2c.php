...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="stylesheet" href="/ThinkphpOS_1.1/Application/Home/View//Public/static/assets/css/main.css">    <link rel="stylesheet" href="css/home.css" media="screen" title="no title">
...
<div id="navbar">
    ...
    <div id="menu">
        <ul>
            <li><a href="#">主页</a></li>
            <li><a href="index2.html">最近动态</a></li>
            <li><a href="index3.html">分享</a></li>
            <li><a href="index4.html">联系我</a></li>
        </ul>
    </div>
    <div id="search">
        <div id="input">
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
            <div class="container-fluid">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand active" href="<?php echo U('Index/index');?>" style="margin-left:30px;margin-right:160px;">OnlineStudy</a>
 ...
 <iframe id="jsfiddle" width="100%" height="1000" src="https://jsfiddle.net/" allowfullscreen="allowfullscreen" frameborder="0" style="margin-top:50px;"></iframe>
</body>
</html>
            ...
            <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                  <ul class="nav navbar-nav" id="title" style="font-family:微软雅黑;">
                    ...
                    <li><a href="../../BackEnd/compileSet/index.html">编程工具</a></li>
                    <li><a href="#">知识测验</a></li>
                  ...
                  <!--<button type="submit" class="btn ">Submit</button>-->
                    ...
                    <?php
 ob_start(); if (isset($_SESSION['username']) && !empty($_SESSION['username'])) { echo "当前用户：".$_SESSION['username']; ?> <a href="../../login.php">退出</a><?php
...
<div class="container" style="margin-top:150px;">
            ...
            <nav class="navbar navbar-default" role="navigation" data-toggle="collapse" style="margin:1px;">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                    <ul class="nav navbar-nav" style="margin-left:160px;">
                      ...
                      <li class="active"><a href="<?php echo U('Page/css3');?>" class="htmlli">CSS3教程</a></li>
        ...
        <div class="col-md-3">
           <ul class="" id="documenter_nav">
              ...
              <ul id="innerul">
                  <li><h5><a href="#html5基础知识">CSS3 简介</a></h5></li>
                  <li><h5><a href="#html5新元素特性">CSS3 边框</a></h5></li>
                  <li><h5><a href="#html5Canvas">CSS3 圆角</a></h5></li>
                  <li><h5><a href="#html5表单元素及属性">CSS3 背景</a></h5></li>
                  <li><h5><a href="#html5内联SVG">CSS3 字体</a></h5></li>
                  <li><h5><a href="#html5video">CSS3 按钮</a></h5></li>
                  <li><h5><a href="#html5Audio">CSS3 动画</a></h5></li>
                  <li><h5><a href="#html5WebSQL">CSS3 图片</a></h5></li>
                  <li><h5><a href="#html5WebSocket">CSS3 弹性盒子</a></h5></li>
                  <li><h5><a href="#css3media">CSS3 多媒体</a></h5></li>
              </ul>
            </li>
 ...
 $sql = "select * from html_css where type='css' id = '11'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
  ...
  <li class="active"><a href="css3.php">2</a></li>
  <li><a href="bootstrap.php">3</a></li>
  <li><a href="foundation.php">4</a></li>
  <li><a href="#">&raquo;</a></li>
</ul>
            <div class="ds-share" data-thread-key="CSS" data-title="【Learn HTML5】——CSS" data-images="此处请替换为分享时显示的图片的链接地址" data-content="此处请替换为分享时显示的内容" data-url="此处请替换为分享时显示的链接地址 " style="margin-top: 50px; margin-left: px; ">
...
<!-- 多说评论框 start -->
  <div class="ds-thread" data-thread-key="CSS" data-title="【Learn HTML5】——CSS" data-url="#" style="margin-top:10px;margin-bottom:200px;"></div>
<!-- 多说评论框 end -->

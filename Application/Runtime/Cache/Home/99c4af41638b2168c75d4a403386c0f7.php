    ...
    <div class="panel panel-default">
      ...
      <form class="form-inline" role="form">
        ...
        <select class="form-control" id="sel1">
            ...
            <option  value="" selected="selected">Java 在线工具</option>
...
<?php
error_reporting(0); $str = $_POST['code']; $file="D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/java/javacode2.java"; $fp=fopen($file,"w");fwrite($fp,$str);fclose($fp); exec("javac D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/java/javacode2.java",$output,$return_val); exec("java javacode2",$output1,$return_val1); ?> 

                  <div class="col-md-5">
                    <textarea placeholder="" value="" class="form-control" id="compiler-textarea-result" rows="18">
                      <?php  $result = $output1; while ($color=each($output1)) { echo $color['value']; } ?>
                    </textarea>

...
<div class="container" style="margin-top:150px;">
            ...
            <nav class="navbar navbar-default" role="navigation" data-toggle="collapse" style="margin:1px;">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                    ...
                    <ul class="nav navbar-nav" style="margin-left:160px;">
                      <li class="active" ><a href="<?php echo U('Page/html5');?>">HTML5教程</a></li>
                      <li><a href="<?php echo U('Page/css3');?>">CSS3教程</a></li>
        ...
        <div class="col-md-3">
           <table class="table table-hover table-striped">
                  ...
                  <ul id="innerul" class="" style="color:#4a3f32;">
                  <li><h5><a href="#html5基础知识">html5 基础知识</a></h5></li>
                  <li><h5><a href="#html5新元素特性">html5 新元素特性</a></h5></li>
                  <li><h5><a href="#html5Canvas">html5 Canvas</a></h5></li>
                  <li><h5><a href="#html5表单元素及属性">html5 表单元素及属性</a></h5></li>
                  <li><h5><a href="#html5内联SVG">html5 内联SVG</a></h5></li>
                  <li><h5><a href="#html5video">html5 video</a></h5></li>
                  <li><h5><a href="#html5Audio">html5 Audio</a></h5></li>
                  <li><h5><a href="#html5WebSQL">html5 Web SQL</a></h5></li>
                  <li><h5><a href="#html5WebSocket">html5 WebSocket</a></h5></li>
        ...
        <div class="col-md-9">
            ...
            <div class="title">
                <h3 style="margin:0px;">HTML5教程</h3>
            </div>
            <div class="contant">
                <h4>
                什么是 HTML5?<br><br>
                HTML5 是下一代 HTML 标准。<br><br>
                HTML , HTML 4.01的上一个版本诞生于 1999 年。自从那以后，Web 世界已经经历了巨变。<br><br>
            ...
            <div class="Tutorial">
                <div id="html5基础知识">
                  <div id="htmlcontent">
                      <tr>
                        <?php
 error_reporting(0); $con = mysql_connect("localhost","root"); if (!$con){ die('Could not connect: ' . mysql_error()); } mysql_select_db('phpwebadmin',$con); mysql_query("set names utf8"); $sql = "select * from html_css where type='html5' && id = '2'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); ?>
                        <tr>
                        <?php
              ...
              <div class="Tutorial">
                ...
                <div id="html5新元素特性">
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type = 'html5' && id = '3'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5Canvas">
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type = 'html5' && id = '4'"; $result=mysql_query($sql); $row1=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row1["content"]."</td><hr><td>".$row1["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5表单元素及属性">
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type='html5' && id = '5'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
 ...
 $sql = "select * from html_css where type='html5' && id = '5'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5video">
                  <div id="htmlcontent">
                        <?php
 $sql = "select * from html_css where type='html5' && id = '7'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
                  </div>
              ...
              <div class="Tutorial">
                ...
                <div id="html5Audio">
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type='html5' && id = '8'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5WebSQL">
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type='html5' && id = '9'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5WebSocket">
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type='html5' && id = '10'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>

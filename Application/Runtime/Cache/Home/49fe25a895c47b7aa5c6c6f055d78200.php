...
<div class="row">
	...
	<div class="col-md-12" style="margin-left:0px;margin-top:50px;">
		<div class="panel panel-default">
            ...
            <option  value="" selected="select">Python 在线工具</option>         
      ...
      <form role="form" id="compiler-form" action="" method="POST">
              <div class="form-group">
                <div class="row">
                  <div class="col-md-7">
                    <textarea class="form-control"  id="code" name="code" rows="18" placeholder=""></textarea>
...
<button type="submit"  class="btn btn-success" id="submitBTN" style="margin-right:12px;"><i class="glyphicon glyphicon-send"></i> 点击运行</button>
 ...
 <?php
 error_reporting(0); $str = $_POST['code']; $file="D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/python/test.py"; $fp=fopen($file,"w");fwrite($fp,$str);fclose($fp); unset($output); $a=exec("python $file",$output,$return_val); $result = $output; ?> 

                  <div class="col-md-5">
                    <textarea placeholder="程序正在运行中……" value="" class="form-control" id="compiler-textarea-result" rows="18">
                      <?php  echo "\n"; while ($color=each($output)) { echo $color['value']; echo "\n"; } ?>
                    </textarea>
                  </div>
                </div>
              </div>
...
$("#submitBTN").click(function() {
	// loadingdata = '程序正在运行中……';
  // setTimeout(loadingdata = '程序正在运行中……',1000);
...
<script src="../assets/js/php1.js" language="JavaScript"></script>
</div>

...
<div class="container" style="margin-top:150px;">
            ...
            <nav class="navbar navbar-default" role="navigation" data-toggle="collapse" style="margin:1px;">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                    <ul class="nav navbar-nav" style="margin-left:160px;">
                      ...
                      <li class="active"><a href="<?php echo U('Page/bootstrap');?>" class="htmlli">Bootstrap教程</a></li>
                      <li><a href="<?php echo U('Page/foundation');?>" class="htmlli">Foundation教程</a></li>
        ...
        <div class="col-md-3">
           <ul class="" id="documenter_nav">
              ...
              <ul id="innerul">
                  <li><h5><a href="#html5基础知识">Bootstrap 简介</a></h5></li>
                  <li><h5><a href="#html5新元素特性">Bootstrap环境安装</a></h5></li>
                  <li><h5><a href="#html5Canvas">Bootstrap可视化布局</a></h5></li>
                  <li><h5><a href="#html5表单元素及属性">Bootstrap CSS</a></h5></li>
                  <li><h5><a href="#html5内联SVG">Bootstrap 栅格系统</a></h5></li>
                  <li><h5><a href="#html5video">Bootstrap 布局组件</a></h5></li>
                  <li><h5><a href="#html5Audio">Bootstrap 插件</a></h5></li>
                  <li><h5><a href="#html5WebSQL">Bootstrap UI编辑器</a></h5></li>
                  <li><h5><a href="#html5WebSocket">Bootstrap HTML编码规范</a></h5></li>
                  <li><h5><a href="#css3media">Bootstrap CSS编码规范</a></h5></li>
              </ul>
            </li>
        ...
        <section id="html5jc">
            ...
            <div class="contant">
                ...
                Bootstrap，来自 Twitter，是目前最受欢迎的前端框架。Bootstrap 是基于 HTML、CSS、JAVASCRIPT 的，它简洁灵活，使得 Web 开发更加快捷。<br><br>
本教程将向您讲解 Bootstrap 框架的基础，通过学习这些内容，您将可以轻松地创建 Web 项目。教程被分为 Bootstrap 基本结构、Bootstrap CSS、Bootstrap 布局组件和 Bootstrap 插件几个部分。每个部分都包含了与该主题相关的简单有用的实例。<br><br>
                </h4>
            </div>
            <div class="Tutorial">
                <!-- <div class="shili">
                ...
                <div id="html5基础知识">
                  ...
                  <div id="htmlcontent">
                      <tr>
                        ...
                        <?php
 error_reporting(0); $con = mysql_connect("localhost","root"); if (!$con){ die('Could not connect: ' . mysql_error()); } mysql_select_db('phpwebadmin',$con); mysql_query("set names utf8"); $sql = "select * from html_css where type='bootstrap' && id = '2'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); ?>
                        <tr>
                        <?php
 echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5新元素特性">
                  <div id="htmltitle">
                    <h4>Bootstrap 环境安装</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type = 'bootstrap' && id = '3'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5Canvas">
                  <div id="htmltitle">
                    <h4>Bootstrap 可视化布局</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type = 'bootstrap' && id = '4'"; $result=mysql_query($sql); $row1=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row1["content"]."</td><hr><td>".$row1["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5表单元素及属性">
                  ...
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '5'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5内联SVG">
                  <div id="htmltitle">
                    <h4>Bootstrap 栅格系统</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '6'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5video">
                  <div id="htmltitle">
                    <h4>Bootstrap 布局组件</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '7'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5Audio">
                  ...
                  <div id="htmlcontent">
                        ...
                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '8'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5WebSQL">
                  <div id="htmltitle">
                    <h4>Bootstrap UI编辑器</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '9'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="html5WebSocket">
                  <div id="htmltitle">
                    <h4>Bootstrap HTM编码规范</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '10'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
              ...
              <div class="Tutorial">
                ...
                <div id="css3media">
                  <div id="htmltitle">
                    <h4>Bootstrap CSS编码规范</h4>
                  </div>
                  <div id="htmlcontent">

                        <?php
 $sql = "select * from html_css where type='bootstrap' id = '11'"; $result=mysql_query($sql); $row=mysql_fetch_assoc($result); echo "<pre><h4><tr><td>".$row["content"]."</td><hr><td>".$row["date"]."</td></tr></h4></pre>"; ?>
  ...
  <li class="active"><a href="bootstrap.php">3</a></li>
  <li><a href="foundation.php">4</a></li>
  <li><a href="#">&raquo;</a></li>
</ul>
            <div class="ds-share" data-thread-key="Bootstrap" data-title="【Learn HTML5】——Bootstrap" data-images="此处请替换为分享时显示的图片的链接地址" data-content="此处请替换为分享时显示的内容" data-url="此处请替换为分享时显示的链接地址 " style="margin-top: 50px; margin-left: px; ">
...
<!-- 多说评论框 start -->
  <div class="ds-thread" data-thread-key="Bootstrap" data-title="【Learn HTML5】——Bootstrap" data-url="#" style="margin-top:10px;margin-bottom:200px;"></div>
<!-- 多说评论框 end -->

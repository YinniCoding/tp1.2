...
<div class="row">
	...
	<div class="col-md-12" style="margin-left:0px;">
		<div class="panel panel-default">
            ...
            <option  value="" selected="selected">PHP 在线工具</option> 
...
<button type="submit"  class="btn btn-success" id="submitBTN" style="margin-right:12px;"><i class="glyphicon glyphicon-send"></i> 点击运行</button>
 ...
 <?php
 error_reporting(0); $str = $_POST['code']; $file="D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/test.php"; $fp=fopen($file,"w");fwrite($fp,$str);fclose($fp); exec("php.exe D:/yinni/WAMP/wamp/www/phpwebadmin/OS(__1.0)/Backend/compileSet/test.php",$output,$return_val); $result = $output; ?> 

                  <div class="col-md-5">
                    <textarea placeholder="运行结果……" class="form-control" id="compiler-textarea-result" rows="18">
                      <?php  while ($color=each($output)) { echo $color['value']; } ?>
                    </textarea>
                  </div>
                </div>
              </div>
